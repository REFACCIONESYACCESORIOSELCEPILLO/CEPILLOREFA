...
class MotorcycleMotorcycle(models.Model):
    ...
    def viewVehicle(self,domain):
        return {
            'name': 'Vehicle',
            'type': 'ir.actions.act_window',
            'view_mode': 'list,form',
            'views': [(self.env.ref('sh_auto_part_vehicle.sh_motorcycle_motorcycle_tree').id,'list'),
                      (self.env.ref('sh_auto_part_vehicle.sh_motorcycle_motorcycle_form').id,'form')],
            'domain': domain,
    ...
    #         'type': 'ir.actions.act_window',
    #         'view_mode': 'list',
    #         'views': [(self.env.ref('sh_auto_part_vehicle.sh_motorcycle_motorcycle_form').id,'form')],
    #         'domain': domain,
    #         'res_model': 'motorcycle.motorcycle',
    #         'context': dict(create=False),
    #         'target': 'current',
